        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-4 right-4 text-gray-500 hover:bg-transparent"
                size="icon-sm"
              />
            }
          >
